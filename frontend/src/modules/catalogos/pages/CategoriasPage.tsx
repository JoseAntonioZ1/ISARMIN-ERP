...
export function CategoriasPage() {
  ...
  const mutacionCrear = useMutation({
    ...
    onError: (e) => setError(e instanceof ApiError ? e.message : 'No se pudo crear la categoría.'),
  })
  ...
  const mutacionEditar = useMutation({
    ...
    onError: (e) => setError(e instanceof ApiError ? e.message : 'No se pudo editar la categoría.'),
  })
